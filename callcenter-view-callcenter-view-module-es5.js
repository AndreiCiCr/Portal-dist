...
var AccidentCardComponent = /** @class */ (function () {
    function AccidentCardComponent() {
    }
    AccidentCardComponent.prototype.ngOnInit = function () {
    };
...
var AccidentCardModule = /** @class */ (function () {
    function AccidentCardModule() {
    }
...
var EnterpriseCardComponent = /** @class */ (function () {
    function EnterpriseCardComponent() {
    }
    EnterpriseCardComponent.prototype.ngOnInit = function () {
    };
    ...
    return EnterpriseCardComponent;
}());
...
var EnterpriseCardModule = /** @class */ (function () {
    function EnterpriseCardModule() {
    }
...
var HomeCardModule = /** @class */ (function () {
    function HomeCardModule() {
    }
...
var InstructionCardComponent = /** @class */ (function () {
    function InstructionCardComponent() {
    }
    InstructionCardComponent.prototype.ngOnInit = function () {
    };
    ...
    return InstructionCardComponent;
}());
...
var InstructionCardModule = /** @class */ (function () {
    function InstructionCardModule() {
    }
...
var ModeCheckerComponent = /** @class */ (function () {
    function ModeCheckerComponent() {
        this.modeChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ModeCheckerComponent.prototype.ngOnInit = function () {
    };
...
var ModeCheckerModule = /** @class */ (function () {
    function ModeCheckerModule() {
    }
...
var OrderCardComponent = /** @class */ (function () {
    ...
    OrderCardComponent.prototype.click = function () {
        console.log('click');
    };
...
var OrderCardModule = /** @class */ (function () {
...
var PbxAgentComponent = /** @class */ (function () {
    function PbxAgentComponent(callsPool, uacService, ngZone) {
    ...
    PbxAgentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.uacService.notifier.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (uaMsg) { return uaMsg.event === 'newRTCSession'; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (uaMsg) { return uaMsg.data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeWhile"])(function () { return _this.alive; })).
            subscribe(function (rtcData) {
            var call = new _services_ua_service_call__WEBPACK_IMPORTED_MODULE_4__["Call"]();
            call.setSession(rtcData);
            _this.callsPool.addCall(call);
        });
        this.currentCall$ = this.callsPool.calls.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["skipWhile"])(function (n) { return !n.length; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (n) { return _this.currentCall = n[0]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (n) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["of"])(n[0]); }));
        this.currentCall$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (n) { return n.status; })).subscribe(function (n) {
            _this.ngZone.run(function () { return _this.currentCallStatus$.next(n.type); });
        });
        this.currentCall$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (n) { return n.liveDuration; })).subscribe(function (n) { return console.log(n); });
    };
    PbxAgentComponent.ctorParameters = function () { return [
...
var PbxAgentModule = /** @class */ (function () {
    function PbxAgentModule() {
    }
...
var Call = /** @class */ (function () {
    ...
    Call.prototype.sendDTMF = function (d, event) {
    ...
    Call.prototype.registerEndCallback = function (fn) {
        this.endingCallback = fn;
    };
    Call.prototype.setSession = function (rtcData) {
        var _this = this;
        this.living = true;
        ...
        this._session.inTalkStatus.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])('')), function (type, subtype) {
            //    console.log('fffffffffffff');
            if (type !== 'active') {
                subtype = '';
            }
            _this.type = type;
            _this.inTalkSubtype = subtype;
            if (type === 'done') {
                _this.living = false;
                if (_this.endingCallback) {
                    _this.endingCallback({
                        target: _this.target,
                        direction: _this.direction,
                        id: _this.id,
                        type: _this.type,
                        inTalkSubtype: _this.inTalkSubtype,
        ...
        this.duration = 0;
        this.liveDuration = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["interval"])(1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeWhile"])(function () { return _this.living; }), 
        // tap(n=>console.log(this.living)),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (c) {
            _this.duration++;
            var value = (_this.duration * 1000) + 1;
        ...
        var dtmfFeed = this._session.dtmf.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());
        this.incomingDTMF = dtmfFeed.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (d) { return d.originator === 'remote'; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (d) { return d.code; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["scan"])(function (current, code) { return current + " " + code; }, ''));
        this.outgoingDTMF = dtmfFeed.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (d) { return d.originator === 'local'; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (d) { return d.code; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["scan"])(function (current, code) { return current + " " + code; }, ''));
    };
    Call.prototype.getCallOptions = function () {
        return this._session.callOptions;
    };
    Call.prototype.hydrate = function (raw) {
        if (!raw) {
            return false;
        }
        this.id = raw.id;
    ...
    Call.prototype.toggleMic = function () {
        this.micEnabled = !this.micEnabled;
        this._session.callOptions.toggleMic();
    };
    Call.prototype.toggleSpeaker = function () {
        this.speakerEnabled = !this.speakerEnabled;
        this._session.callOptions.toggleSpeaker();
    };
    Object.defineProperty(Call.prototype, "icon", {
        get: function () {
            var type = this.type;
            if (type === 'ringing') {
                return 'ring_volume';
...
var SharedCardModule = /** @class */ (function () {
    function SharedCardModule() {
    }
...
var AppTabPanelDirective = /** @class */ (function () {
    function AppTabPanelDirective(templateRef) {
        this.templateRef = templateRef;
    }
    AppTabPanelDirective.ctorParameters = function () { return [
    ...
    return AppTabPanelDirective;
}());

var LayoutCardTabComponent = /** @class */ (function () {
    function LayoutCardTabComponent(renderer) {
        this.renderer = renderer;
    ...
    Object.defineProperty(LayoutCardTabComponent.prototype, "renderTabHeight", {
        get: function () {
            var shift = this.footerHeight + " - " + this.headerHeight;
            //console.log(shift);
    ...
    LayoutCardTabComponent.prototype.ngOnInit = function () {
        // console.log(this.tabNav);
    };
    LayoutCardTabComponent.prototype.ngAfterViewInit = function () {
    ...
    LayoutCardTabComponent.ctorParameters = function () { return [
...
var LayoutCardTabModule = /** @class */ (function () {
    function LayoutCardTabModule() {
    }
...
var LayoutCardComponent = /** @class */ (function () {
    ...
    Object.defineProperty(LayoutCardComponent.prototype, "bodyHeight", {
        get: function () {
    ...
    LayoutCardComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var LayoutCardModule = /** @class */ (function () {
    function LayoutCardModule() {
    }
...
var SubscriberInfoComponent = /** @class */ (function () {
    function SubscriberInfoComponent() {
        this.phone = '+38 (063) 27-81-564';
        this.userName = { fn: 'Ivanov', mn: 'Ivan', ln: 'Ianich' };
        this.info = '';
    }
    SubscriberInfoComponent.prototype.ngOnInit = function () {
    };
...
var SubscriberInfoModule = /** @class */ (function () {
    function SubscriberInfoModule() {
    }
...
var CallcenterViewComponent = /** @class */ (function () {
    function CallcenterViewComponent(uacStoreService) {
        this.uacStoreService = uacStoreService;
    }
    CallcenterViewComponent.prototype.ngOnInit = function () {
    ...
    CallcenterViewComponent.prototype.connect = function () {
        this.uacStoreService.connect();
    };
    ;
    CallcenterViewComponent.prototype.modeChange = function (e) {
        console.log(e);
    };
    CallcenterViewComponent.ctorParameters = function () { return [
    ...
    return CallcenterViewComponent;
}());
...
var CallcenterViewModule = /** @class */ (function () {
    function CallcenterViewModule() {
    }
...
//# sourceMappingURL=callcenter-view-callcenter-view-module-es5.js.map
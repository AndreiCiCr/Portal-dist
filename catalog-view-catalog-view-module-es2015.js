...
let CatalogToolbarComponent = class CatalogToolbarComponent {
    constructor() {
...
let CatalogToolbarModule = class CatalogToolbarModule {
};
...
let EntityCardComponent = class EntityCardComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let EntityCardModule = class EntityCardModule {
};
...
let CatalogViewComponent = class CatalogViewComponent {
    constructor() {
        this.treeShow = true;
    }
    ngOnInit() {
...
let CatalogViewModule = class CatalogViewModule {
};
...
//# sourceMappingURL=catalog-view-catalog-view-module-es2015.js.map